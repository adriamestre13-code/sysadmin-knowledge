...
=================================================================
             ESQUEMA GRÁFICO DE LOS TIPOS DE RAID
=================================================================

1. RAID 0 (Striped Volume - Distribuido en bandas)
-----------------------------------------------------------------
Distribución de bloques en paralelo. Máximo rendimiento, sin seguridad.
...
2. VOLUMEN DISTRIBUIDO (Spanned Volume)
-----------------------------------------------------------------
Suma de espacios en secuencia. Permite discos de diferente tamaño.

       [ DATOS ]
           |
     +-----+-----+
     | (Llega)   | (Cuando se llena D1)
  [Disco 1]   [Disco 2]
  +-------+   +-------+
  | BloqA |   | BloqD |
  | BloqB |   | BloqE |
...
3. RAID 1 (Mirrored Volume - Espejo)
-----------------------------------------------------------------
Duplicación exacta punto a punto. Alta seguridad, menor capacidad.
  ...
  | BloqC |   | BloqC |
  +-------+   +-------+
  Capacidad útil: 50% | Tolerancia a fallos: 1 disco


4. RAID 5 (Distribuido con paridad)
-----------------------------------------------------------------
Paridad intercalada entre todos los discos. Mínimo 3 discos.
     ...
     +---------+   +---------+   +---------+
     |  BloqA1 |   |  BloqA2 |   | ParidadA|
     |  BloqB1 |   | ParidadB|   |  BloqB2 |
     | ParidadC|   |  BloqC1 |   |  BloqC2 |
     +---------+   +---------+   +---------+
  Capacidad útil: N-1 discos | Tolerancia a fallos: 1 disco
=================================================================
